...
// Note: This code is from https://github.com/croby/jquery-autosuggest
            ...
            return this.each( function( x ) {
                ...
                var moveSelection = function( direction ) {
                    if ( $( ":visible", results_holder ).length > 0 ) {
                        ...
                        start.focus();
                        console.log(start.position().top, start.height(), $( results_ul).height(), $( results_ul ).scrollTop());
                        console.log(start.position().top + start.height() > $( results_ul ).height());
                        if ( opts.scroll && start.position().top + start.height() > $( results_ul ).height()) {
                            console.log("scrolling",  ( ( start.position().top + start.height() ) - $( results_ul ).scrollTop() ) );
                            $( results_ul ).scrollTop( ( ( start.position().top + start.height() ) - $( results_ul ).scrollTop() ) );
                        }
                    }
                };
